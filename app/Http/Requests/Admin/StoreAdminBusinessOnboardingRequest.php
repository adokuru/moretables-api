...
class StoreAdminBusinessOnboardingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'restaurants.*.average_price_range' => ['nullable', 'string', 'max:100'],
            'restaurants.*.dining_style' => ['nullable', 'string', 'max:100'],
            'restaurants.*.dress_code' => ['nullable', 'string', 'max:100'],
            ...
            'restaurants.*.address_line_1' => ['nullable', 'string', 'max:255'],
            ...
            'restaurants.*.hours' => ['nullable', 'array', 'min:1'],
            ...
            'restaurants.*.payment_options' => ['nullable', 'array', 'min:1'],
