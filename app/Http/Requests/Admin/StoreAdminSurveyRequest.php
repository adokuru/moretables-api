...
class StoreAdminSurveyRequest extends FormRequest
{
    ...
    {
        return [
            'scope' => ['required', 'string', Rule::in(['platform', 'restaurant'])],
            'restaurant_id' => ['required_if:scope,restaurant', 'nullable', 'integer', 'exists:restaurants,id'],
    ...
    {
        return [
            'restaurant_id.required_if' => 'A restaurant must be provided when scope is restaurant.',
